<div class="navbar navbar-default">
    <div class="navbar-header">
        <a style="color: white" class="navbar-brand navbar-brand-center" href="{{route('home')}}">
        Mumbai Maheshwari
        </a>
            ...
            <ul class="nav navbar-nav navbar-right">
                        ...
                        <div class="dropdown-body">
                            <div class="list-group list-group-divided custom-scrollbar">
                                ...
                                <a class="list-group-item" href="#">
                                    <div class="notification">
                                        <div class="notification-media">
                                            <img class="rounded" width="40" height="40" src="{{ asset('img/profile.jpg') }}" alt="Daniel Taylor">
                                        </div>
                                        <div class="notification-content">
                                ...
                                <a class="list-group-item" href="#">
                                    <div class="notification">
                                        <div class="notification-media">
                                            <img class="rounded" width="40" height="40" src="{{ asset('img/profile.jpg') }}" alt="Emma Lewis">
                                        </div>
                                        <div class="notification-content">
                                ...
                                <a class="list-group-item" href="#">
                                    <div class="notification">
                                        <div class="notification-media">
                                            <img class="rounded" width="40" height="40" src="{{ asset('img/profile.jpg') }}" alt="Sophia Evans">
                                        </div>
                                        <div class="notification-content">
                                            <small class="notification-timestamp">8 hr</small>
                                ...
                                <a class="list-group-item" href="#">
                                    <div class="notification">
                                        <div class="notification-media">
                                            <img class="rounded" width="40" height="40" src="{{ asset('img/profile.jpg') }}" alt="Teddy Wilson">
                                        </div>
                                        <div class="notification-content">
                ...
                <li class="dropdown hidden-xs">
                    <button class="navbar-account-btn" data-toggle="dropdown" aria-haspopup="true">
                        <img class="rounded" width="36" height="36" src="{{ Auth::user()["image_url"] }}" alt="">
